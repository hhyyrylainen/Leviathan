...
public:
	...
	int AddSectionFromMemory(const char *scriptCode, const char *sectionName = "", const int &lineoffset = 0);
...
protected:
	void ClearAll();
	int  Build();
	int ProcessScriptSection(const char *script, const char *sectionname, const int &lineoffset);
