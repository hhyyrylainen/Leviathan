...
{
    return Diligent::float4x4(matrix.m[0][1], matrix.m[0][1], matrix.m[0][2], matrix.m[0][3],
        matrix.m[1][1], matrix.m[1][1], matrix.m[1][2], matrix.m[1][3], matrix.m[2][1],
        matrix.m[2][1], matrix.m[2][2], matrix.m[2][3], matrix.m[3][1], matrix.m[3][1],
