...
DLLEXPORT Float3 StateHelper::Interpolate(
    Member<Float3>& first, Member<Float3>& second, float progress)
{
...
DLLEXPORT Float4 StateHelper::InterpolateQuoternion(
    Member<Float4>& first, Member<Float4>& second, float progress)
{
...
// ------------------------------------ //
DLLEXPORT void PhysicsComponentState::Interpolate(
    Physics& target, PhysicsComponentState& other, float progress)
{
...
DLLEXPORT void PositionComponentState::Interpolate(
    Position& target, PositionComponentState& other, float progress)
{
