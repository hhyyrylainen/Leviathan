...
#define SPECIAL_ITERATOR_FILEHANDLING SPECIAL_ITERATOR_ONNEWLINE_STOP | SPECIAL_ITERATOR_HANDLECOMMENTS_ASSTRING
	...
	public:
		...
		DLLEXPORT void SetDebugMode(bool mode){
		...
		DLLEXPORT inline size_t GetLastValidCharIndex() const{
            ...
            ITERATORCALLBACK_RETURNTYPE(StringIterator::*mf)(Params...), Args&&... args)
        {
            ...
            for (; DataIterator->IsPositionValid(); DataIterator->MoveToNextCharacter()) {
                ...
                if (DebugMode) {
                    ...
                    string datathing = "Iterator: iterating: " +
                        Convert::ToString(GetPosition()) + " (";
	...
	protected:
        ...
        DLLEXPORT inline ITERATORCALLBACK_RETURNTYPE FindFirstQuotedString(
            IteratorPositionData* data, QUOTETYPE quotes,  int specialflags)
        {
            ...
            if(specialflags & SPECIAL_ITERATOR_ONNEWLINE_STOP && IsAtNewLine()){
                ...
                if(data->Positions.Start){
                    ...
                    if((quotes == QUOTETYPE_BOTH && (previouscheck == '"' ||
                                previouscheck == '\'')) || 
            ...
            if(!TakeChar && data->Positions.Start){
                ...
                data->Positions.End = GetPosition() - 1;
                ITR_FUNCDEBUG("On ending quote, end is now: "+
                    Convert::ToString(data->Positions.End));
            }
            ...
            if(End){
                ...
                if(!data->Positions.Start){
                    ...
                    ITR_FUNCDEBUG("First character found: "+
                        Convert::ToString(data->Positions.Start));
        ...
        DLLEXPORT inline ITERATORCALLBACK_RETURNTYPE FindNextNumber(
                ...
                !(CurrentFlags & ITERATORFLAG_SET_INSIDE_COMMENT))
            {
                ...
                if((currentcharacter >= 48) && (currentcharacter <= 57)){
                    ...
                    if(currentcharacter == '+' || currentcharacter == '-'){
                        ...
                        ((currentcharacter == ',') && ((decimal == DECIMALSEPARATORTYPE_COMMA) ||
                            (decimal == DECIMALSEPARATORTYPE_BOTH))))
                    {
        ...
        DLLEXPORT inline ITERATORCALLBACK_RETURNTYPE FindUntilEquality(
        ...
        DLLEXPORT inline ITERATORCALLBACK_RETURNTYPE SkipSomething(
        ...
        DLLEXPORT inline ITERATORCALLBACK_RETURNTYPE FindUntilNewLine(
            IteratorFindUntilData* data)
        {
