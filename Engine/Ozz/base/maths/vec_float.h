...
// Returns the minfimum of each element of _a and _b.
OZZ_INLINE Float4 minf(const Float4& _a, const Float4& _b) {
  return Float4(_a.x < _b.x? _a.x : _b.x,
                _a.y < _b.y? _a.y : _b.y,
                _a.z < _b.z? _a.z : _b.z,
                _a.w < _b.w? _a.w : _b.w);
}
OZZ_INLINE Float3 minf(const Float3& _a, const Float3& _b) {
  return Float3(_a.x < _b.x? _a.x : _b.x,
                _a.y < _b.y? _a.y : _b.y,
                _a.z < _b.z? _a.z : _b.z);
}
OZZ_INLINE Float2 minf(const Float2& _a, const Float2& _b) {
...
OZZ_INLINE Float4 Clamp(const Float4& _a, const Float4& _v, const Float4& _b) {
  const Float4 minf(_v.x < _b.x? _v.x : _b.x,
                   _v.y < _b.y? _v.y : _b.y,
                   _v.z < _b.z? _v.z : _b.z,
                   _v.w < _b.w? _v.w : _b.w);
  return Float4(_a.x > minf.x? _a.x : minf.x,
                _a.y > minf.y? _a.y : minf.y,
                _a.z > minf.z? _a.z : minf.z,
                _a.w > minf.w? _a.w : minf.w);
}
OZZ_INLINE Float3 Clamp(const Float3& _a, const Float3& _v, const Float3& _b) {
  const Float3 minf(_v.x < _b.x? _v.x : _b.x,
                   _v.y < _b.y? _v.y : _b.y,
                   _v.z < _b.z? _v.z : _b.z);
  return Float3(_a.x > minf.x? _a.x : minf.x,
                _a.y > minf.y? _a.y : minf.y,
                _a.z > minf.z? _a.z : minf.z);
}
OZZ_INLINE Float2 Clamp(const Float2& _a, const Float2& _v, const Float2& _b) {
  const Float2 minf(_v.x < _b.x? _v.x : _b.x,
                  _v.y < _b.y? _v.y : _b.y);
  return Float2(_a.x > minf.x? _a.x : minf.x,
                _a.y > minf.y? _a.y : minf.y);
}
}  // math
}  // ozz
