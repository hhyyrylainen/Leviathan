...
void MultiTextureShader::Release(){
	// shutdown shaders //
	ReleaseShader();

}
// ------------------------------------ //
bool MultiTextureShader::Render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix, ID3D11ShaderResourceView** texture){
...
bool Leviathan::MultiTextureShader::InitShader(ID3D11Device* dev, const wstring &vsfilename, const wstring &psfilename){
	...
	// compile shaders //
	hr = D3DX11CompileFromFile(vsfilename.c_str(), NULL, NULL, "MultiTextureVertexShader", "vs_5_0", CompileFlags, 0, NULL, 
	...
	hr = D3DX11CompileFromFile(psfilename.c_str(), NULL, NULL, "MultiTexturePixelShader", "ps_5_0", CompileFlags, 0, NULL, 
...
void MultiTextureShader::ReleaseShader(){
...
void MultiTextureShader::PrintShaderError(ID3D10Blob* datadumb){
	char* Errors;
...
bool MultiTextureShader::SetShaderParams(ID3D11DeviceContext* devcont, D3DXMATRIX worldmatrix, D3DXMATRIX viewmatrix, D3DXMATRIX projectionmatrix, ID3D11ShaderResourceView** texture){
	HRESULT hr = S_OK;
	...
	devcont->PSSetShaderResources(0, 2, texture);

	return true;
}
void MultiTextureShader::ShaderRender(ID3D11DeviceContext* devcont, int indexcount){
	// set input layout
